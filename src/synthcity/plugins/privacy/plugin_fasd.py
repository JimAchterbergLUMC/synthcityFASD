...
from synthcity.plugins.core.models.tabular_fasd import TabularFASD
from synthcity.plugins.core.plugin import Plugin
from synthcity.plugins.core.schema import Schema
from synthcity.utils.constants import DEVICE


class FASDPlugin(Plugin):
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        # fasd params
        self.fasd_n_iter = fasd_n_iter
        self.fasd_n_units_embedding = fasd_n_units_embedding
        self.fasd_encoder_n_layers_hidden = fasd_encoder_n_layers_hidden
        self.fasd_encoder_n_units_hidden = fasd_encoder_n_units_hidden
        self.fasd_encoder_nonlin = fasd_encoder_nonlin
        self.fasd_encoder_dropout = fasd_encoder_dropout
        self.fasd_decoder_n_layers_hidden = fasd_decoder_n_layers_hidden
        self.fasd_decoder_n_units_hidden = fasd_decoder_n_units_hidden
        self.fasd_decoder_nonlin = fasd_decoder_nonlin
        self.fasd_decoder_dropout = fasd_decoder_dropout
    ...
    def _fit(self, X: DataLoader, *args: Any, **kwargs: Any) -> "FASDPlugin":
        ...
        self.model = TabularFASD(
            ...
            fasd_n_iter=self.fasd_n_iter,
            fasd_n_units_embedding=self.fasd_n_units_embedding,
            fasd_encoder_n_layers_hidden=self.fasd_encoder_n_layers_hidden,
            fasd_encoder_n_units_hidden=self.fasd_encoder_n_units_hidden,
            fasd_encoder_nonlin=self.fasd_encoder_nonlin,
            fasd_encoder_dropout=self.fasd_encoder_dropout,
            fasd_decoder_n_layers_hidden=self.fasd_decoder_n_layers_hidden,
            fasd_decoder_n_units_hidden=self.fasd_decoder_n_units_hidden,
            fasd_decoder_nonlin=self.fasd_decoder_nonlin,
            fasd_decoder_dropout=self.fasd_decoder_dropout,
        ...
        # no input data needed to fit, since representations already created during model instantiation
        # these representations are used to fit a VAE when calling the fit method
